...
## An analysis of how different factors affect your likelihood of attending work, and which factor has the most predominant effect.
...
- First we want to take an average to some important numeric values, such as absenteeism time, so that we can have a brief understanding about what the numbers will be like to this table 

- In this analysis, our group will use linear graph, box plot, and other various graphs in order to  understand the data better.

- Meanwhile our group is aiming for by using the graphs to suggest relationships between different variables. 
