# Absenteeism at work
======================
### By Jason Gunn, Xuyan Wang, Niamh Wexelstein and Samuel Buxton. 
...
```
We also find it may be useful to get rid of the people with 0 hours of absenteeism, becuase we are only interested in people who have actually been absent.
```{r}
...
After social, we looked at geographical factors. Our hypothesis is that further away you live from work, the more likely you are to be absent. We think this because if you live further away, you are more likely to encounter traffic which could accumulate more hours of absence. Living far away from work could also lead to having to take public transport, which can be unreliable, as well as transportation expense, which could also affect absenteeism.
...
# Geographical variables observation
We observed that the further away from work you live, the less absenteeism hours you will have. However, the residual graph is not really random enough (as it resembles a fan-shape), so we assume it is better to do a log based one.

# Linear regression plus logs 
This time we do log(absenteeism time in hours), and see what the new observation is.
...
```
Again, after our linear regression plus logs we believe it is good to run another residual plot.
```{r}
